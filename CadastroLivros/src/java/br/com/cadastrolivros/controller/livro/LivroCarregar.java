...
import br.com.cadastrolivros.dao.GenericDAO;
...
public class LivroCarregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            GenericDAO livroDao = new LivroDAO();
            Livro oLivro = (Livro) livroDao.carregar(id);
            ...
            System.out.println("Problema na Servelet carrregar Livro!Erro: " + ex.getMessage());
            ex.printStackTrace();   
        }
    }
